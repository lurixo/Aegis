...
internal object SymbolAssociations {
    ...
    val exemptions: List<Exemption> = listOf(
        Exemption("上/下标拉丁字母变体,从符号面板选择而不占用汉字读音",
            "ᵃ", "ᵇ", "ᶜ", "ᵈ", "ᵉ", "ᶠ", "ᵍ", "ʰ", "ʲ", "ᵏ", "ˡ", "ᵐ", "ᵒ", "ᵖ", "ʳ", "ˢ", "ᵗ", "ᵘ", "ᵛ", "ʷ", "ˣ", "ʸ", "ᶻ", "ᶞ", "ᴬ", "ᴮ", "ᴰ", "ᴱ", "ᴳ", "ᴴ", "ᴵ", "ᴶ", "ᴷ", "ᴸ", "ᴹ", "ᴺ", "ᴼ", "ᴾ", "ᴿ", "ᵀ", "ᵁ", "ⱽ", "ᵂ", "ₕ", "ᵢ", "ⱼ", "ₖ", "ₗ", "ₘ", "ₙ", "ₚ", "ᵣ", "ₛ", "ₜ", "ᵤ", "ᵥ", "ₔ", "ᵧ"),
        Exemption("汉字及财务数字字形,从词库候选或符号面板选择",
            "壹", "贰", "叁", "肆", "伍", "陆", "柒", "捌", "玖", "拾", "佰", "仟", "万", "亿", "貳", "參", "陸", "萬", "億"),
        Exemption("装饰性或专业箭头变体,从箭头面板选择以区别基本方向箭头",
            "⇄", "⇆", "⇅", "⇵", "↞", "↠", "↟", "↡", "⤊", "⤋", "↢", "↣", "↤", "↦", "↥", "↧", "↰", "↱", "↲", "↳", "↜", "↝", "⇜", "⇝", "⇎", "⇦", "⇨", "⇧", "⇩", "⇪", "➝", "➞", "➟", "➠", "➢", "➣", "➥", "➦", "➧", "➨", "➩", "➪", "➫", "➬", "➭", "➮", "➯", "➱", "➲", "➳", "➴", "➵", "➶", "➷", "➸", "➹", "➺", "➻", "➼", "➽", "➾", "☜", "☞", "☝", "☟"),
        Exemption("竖排标点字形,从竖排面板选择以保留普通标点的拼音关联",
            "︐", "︒", "︑", "︓", "︔", "︕", "︖", "︙", "︰", "︵", "︶", "︷", "︸", "︹", "︺", "︿", "﹀", "︽", "︾", "﹁", "﹂", "﹃", "﹄", "︻", "︼", "︗", "︘", "﹇", "﹈", "︱", "︲", "︳", "︴", "﹉", "﹊", "﹌", "﹍", "﹎", "￣"),
        Exemption("国际音标与拉丁字母组合,从音标面板或26键直接输入",
            "ɑː", "ɔː", "ɜː", "iː", "uː", "eɪ", "aɪ", "ɔɪ", "ɪə", "eə", "ʊə", "əʊ", "aʊ", "p", "b", "t", "d", "k", "g", "f", "v", "s", "z", "h", "m", "l", "r", "j", "w", "ts", "dz", "tʃ", "dʒ", "tr", "dr"),
        Exemption("西文重音与标点表现变体,从符号面板选择",
            "´", "¨", "¡", "¿", "¦", "ˇ"),
