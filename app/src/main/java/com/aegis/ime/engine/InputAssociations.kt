...
object InputAssociations {
    ...
    // Keyed by toneless full pinyin (lowercase, no separators). First entries rank first.
    ...
    /** Associated glyphs for the exact full [pinyin] (lowercased), capped; empty when none. */
