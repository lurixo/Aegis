...
private val LICENSE_ITEMS = listOf(
    ...
    LicenseItem(R.string.license_mechvibes_name, "2021 Hai Nguyen", "MIT", "https://github.com/hainguyents13/mechvibes", R.string.license_mechvibes_note, modified = true),
    LicenseItem(R.string.license_silver_name, "Akira", "GPL-3.0", "https://mechvibes.com/sound-packs/custom-sound-pack-1203000000058/", R.string.license_silver_note, modified = true),
