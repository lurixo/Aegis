...
/**
 * E4 — 模糊拼音 settings. (The existing single switch, extracted here so the startup screen
 * (J②) and the settings list can share one component. Per-rule toggles are backed
 * by individual prefs keys, kept in sync with the decoder's per-rule fuzzy matching.)
 */
@Composable
