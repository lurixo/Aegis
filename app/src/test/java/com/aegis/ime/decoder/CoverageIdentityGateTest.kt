...
class CoverageIdentityGateTest {
    ...
    private companion object {
        const val BASELINE_RESOURCE = "/coverage-identity-68354991.tsv"
        const val BASELINE_COMMIT = "6835499113809d371d5ec3bc8aacbc01e60a5444"
        const val DICTIONARY_PACK_SHA256 = "c31dd735a7eb4ff673b7a6e47e6fd5fd17153d022c92aa805f9a8b0c8b46d0af"
        val ASSET_SHA256 = linkedMapOf(
            "aegis_dict.bin" to "69f10960273a963982495076e91595ce36fe2748684d44022df9c5bdc0480f79",
            "aegis_t9.bin" to "686ddfca8c6f8e18691a7a6d6fc871411f9531095e3268b503ad22e1e05a94b7",
            "aegis_jianpin.bin" to "4e01231fa3f1ffa9c8a862bea4020e1ea70d82565a5fa3985190f572e21f7863",
            "aegis_lm.bin" to "7abc92b29c411c7dc737f1f6cacb1c26a3d353083ca31b829c29ab1d76ce6aae",
        )
        const val CANONICAL =
    ...
    @Test fun everyCandidateKeepsTheKeyCountItAteInTheBaseline() {
        ...
        assertTrue(
            "candidate groups must keep the 68354991 per-probe (word, coveredLen) digest: " +
