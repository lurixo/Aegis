...
class ReleaseDictionaryBuildToolTest {
    ...
    fun releaseDictionaryToolBuildsLatestFullPackMetadataWithoutUploading() {
        ...
        assertTrue(script.contains("aegis_pfx_letter.idx"))
        assertTrue(script.contains("aegis_pfx_digit.idx"))
        assertTrue(script.contains("aegis_pfx_initials.idx"))
        assertTrue(script.contains("AEGP v4"))
