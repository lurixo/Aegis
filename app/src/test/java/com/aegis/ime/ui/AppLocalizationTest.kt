...
class AppLocalizationTest {
    ...
    fun chinese_locale_uses_chinese_app_ui_strings() {
        ...
        assertEquals("已选择 0 项", ctx.resources.getQuantityString(R.plurals.clip_selected_count, 0, 0))
        ...
        assertEquals("添加词", ctx.getString(R.string.user_dict_add_sheet_button))
        assertEquals("更多", ctx.getString(R.string.user_dict_more_button))
    ...
    fun english_locale_uses_english_app_ui_strings() {
        ...
        assertEquals("0 selected", ctx.resources.getQuantityString(R.plurals.clip_selected_count, 0, 0))
        ...
        assertEquals("Add word", ctx.getString(R.string.user_dict_add_sheet_button))
        assertEquals("More", ctx.getString(R.string.user_dict_more_button))
