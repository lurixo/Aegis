...
class AppLocalizationTest {
    ...
    fun chinese_locale_uses_chinese_app_ui_strings() {
        ...
        assertEquals("清空自动学习", ctx.getString(R.string.user_dict_auto_clear_button))
    ...
    fun english_locale_uses_english_app_ui_strings() {
        ...
        assertEquals("Clear auto-learning", ctx.getString(R.string.user_dict_auto_clear_button))
